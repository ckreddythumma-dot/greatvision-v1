      ...
      <div className="page-shell" style={{ display: 'flex', minHeight: '100dvh' }}>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="concept-main" style={{ padding: '0 48px 80px' }} key={activeTab}>
            ...
            {activeTab === 1 && <GenericLabTab lab={MUX_LAB} concept="mux-demux" />}
            {activeTab === 2 && <PYQsTab pyqs={MUX_PYQS} insight={MUX_INSIGHT} conceptTitle="MUX / DEMUX" />}
            {activeTab === 3 && <PracticeTab practice={MUX_PRACTICE} conceptTitle="MUX / DEMUX" />}
          </div>
        </main>
      </div>
    </>
