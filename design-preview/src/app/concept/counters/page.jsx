      ...
      <div className="page-shell" style={{ display: 'flex', minHeight: '100dvh' }}>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="concept-main" style={{ padding: '0 48px 80px' }} key={activeTab}>
            ...
            {activeTab === 1 && <GenericLabTab lab={COUNTER_LAB} concept="counters" />}
            {activeTab === 2 && <PYQsTab pyqs={COUNTER_PYQS} insight={COUNTER_INSIGHT} conceptTitle="Counters" />}
            {activeTab === 3 && <PracticeTab practice={COUNTER_PRACTICE} conceptTitle="Counters" />}
          </div>
        </main>
      </div>
    </>
