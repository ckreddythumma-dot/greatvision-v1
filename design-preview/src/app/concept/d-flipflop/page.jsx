      ...
      <div className="page-shell" style={{ display: 'flex', minHeight: '100dvh' }}>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="concept-main" style={{ padding: '0 48px 80px' }} key={activeTab}>
            ...
            {activeTab === 1 && <GenericLabTab lab={DFF_LAB} concept="d-flipflop" />}
            {activeTab === 2 && <PYQsTab pyqs={DFF_PYQS} insight={DFF_INSIGHT} conceptTitle="D Flip-Flop" />}
            {activeTab === 3 && <PracticeTab practice={DFF_PRACTICE} conceptTitle="D Flip-Flop" />}
          </div>
        </main>
      </div>
    </>
