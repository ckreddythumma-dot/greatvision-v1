      ...
      <div className="page-shell" style={{ display: 'flex', minHeight: '100dvh' }}>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="concept-main" style={{ padding: '0 48px 80px' }} key={activeTab}>
            ...
            {activeTab === 1 && <GenericLabTab lab={DE_LAB} concept="diff-eq" />}
            {activeTab === 2 && <PYQsTab pyqs={DE_PYQS} insight={DE_INSIGHT} conceptTitle="Differential Equations" />}
            {activeTab === 3 && <PracticeTab practice={DE_PRACTICE} conceptTitle="Differential Equations" />}
          </div>
        </main>
      </div>
    </>
