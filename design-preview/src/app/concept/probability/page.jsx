      ...
      <div className="page-shell" style={{ display: 'flex', minHeight: '100dvh' }}>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="concept-main" style={{ padding: '0 48px 80px' }} key={activeTab}>
            ...
            {activeTab === 1 && <GenericLabTab lab={PROB_LAB} concept="probability" />}
            {activeTab === 2 && <PYQsTab pyqs={PROB_PYQS} insight={PROB_INSIGHT} conceptTitle="Probability & Statistics" />}
            {activeTab === 3 && <PracticeTab practice={PROB_PRACTICE} conceptTitle="Probability & Statistics" />}
          </div>
        </main>
      </div>
    </>
