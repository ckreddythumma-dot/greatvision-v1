      ...
      <div className="page-shell" style={{ display: 'flex', minHeight: '100dvh' }}>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="concept-main" style={{ padding: '0 48px 80px' }} key={activeTab}>
            ...
            {activeTab === 1 && <GenericLabTab lab={KMAP_LAB} concept="kmap" />}
            {activeTab === 2 && <PYQsTab pyqs={KMAP_PYQS} insight={KMAP_INSIGHT} conceptTitle="K-Map" />}
            {activeTab === 3 && <PracticeTab practice={KMAP_PRACTICE} conceptTitle="K-Map" />}
          </div>
        </main>
      </div>
    </>
