      ...
      <div className="page-shell" style={{ display: 'flex', minHeight: '100dvh' }}>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="concept-main" style={{ padding: '0 48px 80px' }} key={activeTab}>
            ...
            {activeTab === 1 && <GenericLabTab lab={CALC_LAB} concept="calculus" />}
            {activeTab === 2 && <PYQsTab pyqs={CALC_PYQS} insight={CALC_INSIGHT} conceptTitle="Calculus" />}
            {activeTab === 3 && <PracticeTab practice={CALC_PRACTICE} conceptTitle="Calculus" />}
          </div>
        </main>
      </div>
    </>
