...
export default function CMOSVizSidebar({ subject }) {
  const groups = [
    { name: 'MOSFET', items: [
    ...
    { name: 'MOSFET Amplifier', items: [
      { id: 'mosfet-amplifier', label: 'CS amp gain' },
    ] },
    { name: 'CMOS Inverter', open: true, items: [
      { id: 'cmos-inverter', label: 'VTC & switching', active: true },
    ] },
  ]
  return (
