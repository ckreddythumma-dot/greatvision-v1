...
export default function PNVizSidebar({ subject }) {
  const groups = [
    { name: 'MOSFET', items: [
      { id: 'mosfet-iv', label: 'I–V Characteristics' },
    ] },
    { name: 'PN Junction Diode', open: true, items: [
      { id: 'pn-junction', label: 'I–V & depletion', active: true },
      { id: 'pn-cap', label: 'Junction capacitance' },
    ] },
